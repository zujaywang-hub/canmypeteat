...
import { CAT_FOODS } from "../../lib/articles-data";
...
export default function CanCatsEatIndex() {
  ...
  const filtered = filter === "all" ? CAT_FOODS : CAT_FOODS.filter(a => a.safety === filter);
  const safeCount = CAT_FOODS.filter(a => a.safety === "safe").length;
  const cautionCount = CAT_FOODS.filter(a => a.safety === "caution").length;
  const toxicCount = CAT_FOODS.filter(a => a.safety === "toxic").length;

  const siteUrl = "https://canmypeteat.app";
  const title = isCn ? "\u8c93\u54aa\u53ef\u4ee5\u5403\u4ec0\u9ebc\uff1f\u5b8c\u6574\u98df\u7269\u5b89\u5168\u6307\u5357 | CanMyPetEat" : "What Can Cats Eat? Complete Food Safety Guide | CanMyPetEat";
  const description = isCn
    ? `\u5b8c\u6574\u7684\u8c93\u54aa\u98df\u7269\u5b89\u5168\u6307\u5357\u3002\u67e5\u770b ${CAT_FOODS.length} \u7a2e\u98df\u7269\u5c0d\u8c93\u54aa\u662f\u5426\u5b89\u5168\u3001\u9700\u8b39\u614e\u6216\u6709\u6bd2\u3002`
    : `Complete cat food safety guide. Check if ${CAT_FOODS.length}+ foods are safe, need caution, or are toxic for your cat.`;

  const schema = {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    "name": "What Can Cats Eat?",
    "description": description,
    "url": `${siteUrl}/can-cats-eat`,
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Can Cats Eat", "item": `${siteUrl}/can-cats-eat` },
    ],
  };
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${siteUrl}/can-cats-eat`} />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${siteUrl}/can-cats-eat`} />
      ...
      <div style={{ minHeight: "100vh", background: "#0f172a", fontFamily: "'DM Sans', sans-serif", color: "#e2e8f0" }}>
        ...
        <main style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 20px 80px" }}>
          ...
          <div style={{ fontSize: "13px", color: "#64748b", marginBottom: "24px" }}>
            ...
            <span style={{ color: "#94a3b8" }}>{isCn ? "\u8c93\u54aa\u53ef\u4ee5\u5403\u4ec0\u9ebc" : "Can Cats Eat"}</span>
          </div>
          ...
          <p style={{ fontSize: "18px", lineHeight: 1.7, color: "#94a3b8", margin: "0 0 32px 0" }}>
            {isCn
              ? `\u67e5\u770b ${CAT_FOODS.length} \u7a2e\u98df\u7269\u5c0d\u8c93\u54aa\u662f\u5426\u5b89\u5168\u3002\u9ede\u64ca\u4efb\u4f55\u98df\u7269\u67e5\u770b\u8a73\u7d30\u8aaa\u660e\u3001\u98df\u7528\u5efa\u8b70\u548c\u6ce8\u610f\u4e8b\u9805\u3002`
              : `Browse ${CAT_FOODS.length} foods to check if they're safe for your cat. Click any food for detailed safety info, serving tips, and what to watch for.`}
          </p>
          ...
          <div style={{ display: "flex", gap: "8px", marginBottom: "28px", flexWrap: "wrap" }}>
            {[
              { key: "all", label: isCn ? "\u5168\u90e8" : "All", count: CAT_FOODS.length },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: "12px" }}>
            {filtered.map(item => {
              ...
              return (
                <a key={item.slug} href={`/can-cats-eat/${item.slug}`} style={{
          ...
          <div style={{ marginTop: "48px", padding: "24px", borderRadius: "16px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", textAlign: "center" }}>
            ...
            <h3 style={{ margin: "0 0 8px 0", fontSize: "18px", color: "#e0f2fe" }}>
              {isCn ? "\u4e5f\u6709\u990a\u72d7\u55ce\uff1f" : "Have a Dog Too?"}
            </h3>
            <p style={{ margin: "0 0 16px 0", fontSize: "14px", color: "#94a3b8" }}>
              {isCn ? "\u67e5\u770b\u72d7\u72d7\u7684\u5b8c\u6574\u98df\u7269\u5b89\u5168\u6307\u5357" : "Check our complete dog food safety guide"}
            </p>
            <a href="/can-dogs-eat" style={{ display: "inline-block", padding: "12px 28px", borderRadius: "10px", background: "rgba(56,189,248,0.15)", border: "1px solid rgba(56,189,248,0.3)", color: "#38bdf8", textDecoration: "none", fontWeight: 600, fontSize: "14px" }}>
          ...
          <div style={{ marginTop: "24px", padding: "24px", borderRadius: "16px", background: "rgba(239,68,68,0.06)", border: "1px solid rgba(239,68,68,0.15)", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", gap: "8px", justifyContent: "center", flexWrap: "wrap" }}>
              {[
                { href: "/pet-safety/cat-ate-chocolate", label: isCn ? "\u8c93\u5403\u4e86\u5de7\u514b\u529b" : "Cat Ate Chocolate" },
                { href: "/pet-safety/cat-ate-onion", label: isCn ? "\u8c93\u5403\u4e86\u6d0b\u8525" : "Cat Ate Onion" },
                { href: "/pet-safety/cat-ate-lily", label: isCn ? "\u8c93\u5403\u4e86\u767e\u5408\u82b1" : "Cat Ate Lily" },
                { href: "/pet-safety/foods-toxic-to-cats", label: isCn ? "\u6709\u6bd2\u98df\u7269\u6e05\u55ae" : "Toxic Foods List" },
              ].map(link => (
