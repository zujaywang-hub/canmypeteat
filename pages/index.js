          ...
          {!results && (
            ...
            <div style={{ maxWidth:"580px", margin:"0 auto", padding:"32px 20px 0" }}>
              ...
              <div style={{ marginBottom:"24px" }}>
                ...
                <div style={{ display:"flex", flexWrap:"wrap", gap:"6px" }}>
                  {[{s:"asparagus",cn:"蘆筍"},{s:"avocado",cn:"酪梨"},{s:"banana",cn:"香蕉"},{s:"beef",cn:"牛肉"},{s:"blueberry",cn:"藍莓"},{s:"bread",cn:"麵包"},{s:"cantaloupe",cn:"哈密瓜"},{s:"cheese",cn:"起司"},{s:"chicken",cn:"雞肉"},{s:"chocolate",cn:"巧克力"},{s:"coconut",cn:"椰子"},{s:"cucumber",cn:"小黃瓜"},{s:"dragon-fruit",cn:"火龍果"},{s:"duck",cn:"鴨肉"},{s:"eggs",cn:"雞蛋"},{s:"garlic",cn:"大蒜"},{s:"green-bean",cn:"四季豆"},{s:"guava",cn:"芭樂"},{s:"ice-cream",cn:"冰淇淋"},{s:"kiwi",cn:"奇異果"},{s:"lamb",cn:"羊肉"},{s:"lettuce",cn:"生菜"},{s:"liver",cn:"肝臟"},{s:"longan",cn:"龍眼"},{s:"lychee",cn:"荔枝"},{s:"mango-full",cn:"芒果"},{s:"melon",cn:"甜瓜"},{s:"milk",cn:"牛奶"},{s:"onions",cn:"洋蔥"},{s:"passion-fruit",cn:"百香果"},{s:"pea",cn:"豌豆"},{s:"peach",cn:"水蜜桃"},{s:"pineapple",cn:"鳳梨"},{s:"pumpkin",cn:"南瓜"},{s:"rice",cn:"白飯"},{s:"salmon",cn:"鮭魚"},{s:"shrimp",cn:"蝦子"},{s:"strawberry",cn:"草莓"},{s:"taro",cn:"芋頭"},{s:"tuna",cn:"鮪魚"},{s:"tuna-cooked",cn:"熟鮪魚"},{s:"tuna-raw",cn:"生鮪魚"},{s:"turkey",cn:"火雞肉"},{s:"wax-apple",cn:"蓮霧"},{s:"watermelon",cn:"西瓜"},{s:"yogurt",cn:"優格"},{s:"zucchini",cn:"櫛瓜"}].map((item) => (
              ...
              <div style={{ marginBottom:"24px" }}>
                ...
                <div style={{ display:"flex", flexWrap:"wrap", gap:"6px" }}>
                  {[
                    { slug:"acana", label:"ACANA (A-)", cn:"愛肯拿 ACANA (A-)" },
                    { slug:"iams", label:"IAMS (B)", cn:"愛慕思 IAMS (B)" },{ slug:"sheba", label:"Sheba (B)", cn:"Sheba (B)" },
                    { slug:"friskies", label:"Friskies (C)", cn:"喜躍 Friskies (C)" },{ slug:"meow-mix", label:"Meow Mix (C)", cn:"Meow Mix (C)" },
                  ].map((b) => (
            ...
            <footer style={{ textAlign:"center", padding:"40px 0 60px", color:"#334155", fontSize:"13px" }}>
              <div style={{ marginBottom:"16px", display:"flex", justifyContent:"center", gap:"24px", flexWrap:"wrap" }}>
                {(isCn ? ["148 篇文章", "83 種狗食物", "46 種貓食物", "5 個品牌評比", "100% 免費"] : ["148 articles", "83 dog foods", "46 cat foods", "5 brand reviews", "100% free"]).map((f) => (
